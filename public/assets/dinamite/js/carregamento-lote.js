...
$(document).ready(function () {
  $('#ver-mais').click(function () {
    ...
    var qtdRegistros = $(
      'section#cases #container .' + categoria
    ).length; /*Conta quantas vezes a Class aparece*/
    ...
    $.post(
      'resources/carrega-registros.php',
      {
  ...
  $('#ver-mais-clientes').click(function () {
    ...
    // Informações
    var qtdRegistros = $(
      'section#clientes #container .marca'
    ).length; /*Conta quantas vezes a Class aparece*/
    ...
    // Faz requisição ajax e envia o ID do último registro via método POST
    $.post(
      'resources/carrega-clientes.php',
      {
        qtdRegistros: qtdRegistros,
