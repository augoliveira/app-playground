$(document).ready(function () {
  ...
  document.cookie =
    'widthScreen=' +
    widthScreen +
    '; expires=Thu, 31 Dec 2030 12:00:00 UTC; path=/';
  ...
  $('#contato #opcao1').click(function () {
    ...
    $('section#contato .conteudo p').html(
      'Envie sua dúvida ou sugestão. Nossa equipe <br>responderá o mais breve possível.'
    );
  });
  $('#contato #opcao2').click(function () {
    ...
    $('section#contato .conteudo p').html(
      'Você é muito bom no que faz e não se sentiu intimidado<br>com nossos projetos? Chega aí e nos surpreenda.'
    );
  });
  ...
  $('#cases-menu li').click(function () {
    ...
    window.location.href =
      'http://dinamitecriativa.com.br/index.php?pg=cases#' + id;
  });
  ...
  $('#cases-menu-interno li').click(function () {
    ...
    if (id != 'todos') {
      $('section#cases #container .todos').stop().hide();
    }
    $('section#cases #container .' + id)
      .stop()
      .fadeIn();
  ...
  if (
    ...
    $('section#cases #container .' + tipoAncora)
      .stop()
      .fadeIn();
  ...
  function centralizarElementoFixed(elemento, diferenca, tipo) {
    //Tipo
    if (tipo == 'margem') {
      var propriedade = 'margin-top';
    } else {
      var propriedade = 'padding-top';
    }
  ...
  //Menu
  function menuDown() {
    $('#menu-open #navegacao-open').slideDown(500);
  }
  function redesUp() {
    $('#menu-open #rs').fadeIn(500);
  }
  ...
  $('form#envia-contato').submit(function (e) {
    ...
    if ($('input[name="nome"]', form).val() == '') {
      $('input[name="nome"]', form)
        .css('border-bottom', '1px solid #be0007')
        .focus();
      return false;
    }
    ...
    if (
      ...
      !checkMail($('input[name="email"]', form).val())
    ) {
